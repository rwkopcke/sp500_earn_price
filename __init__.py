'''
    set global absolute paths for project's addresses
        using Path.cwd() to "sp_earn_price" project's directory
    ...
    this code creates params, which is accessed by other scripts
'''
